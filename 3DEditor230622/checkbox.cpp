...
void Checkbox::Update() {
	...
	if (click) { checked = !checked; Upload(); }
	else { Sync(); }
	render();
}
void Checkbox::Discard() { hovered = false; }
void Checkbox::PreUpdate() {
	bool ok = dhv <= dep &&
